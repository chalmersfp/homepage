...
The Functional Programming unit develops programming languages, methods and tools that make software more reliable, secure and usable. Chalmers has been an international hotspot for functional programming for several decades, with influential contributions to Haskell, property-based testing, domain-specific languages and language technology. The unit also conducts research in usable artificial intelligence.
...
- [Aarne Ranta](https://www.chalmers.se/en/persons/aarne/)
- [Carl-Johan Seger (emeritus)](https://www.chalmers.se/en/persons/secarl/)
- [John Hughes (emeritus)](https://www.chalmers.se/en/persons/rjmh/)
- [Mary Sheeran (emerita)](https://www.chalmers.se/en/persons/ms/)
- [Patrik Jansson](https://www.chalmers.se/en/persons/patrikj/)
...
- [Nick Smallbone](https://www.chalmers.se/en/persons/nicsma/), Researcher
- [Yinan Yu](https://www.chalmers.se/en/persons/yinan/), Assistant Professor
...
- [Ekatarina Voloshina](https://www.chalmers.se/en/persons/ekavol/), doctoral student
- [Erik Aerts](https://www.chalmers.se/en/persons/aeerik/), doctoral student
- [Henrik Jansson Valter](https://www.chalmers.se/en/persons/valterh/), doctoral student
- [Niklas Deworetzki](https://www.chalmers.se/en/persons/nikdew/), doctoral student
- [Robert Krook](https://www.chalmers.se/en/persons/krookr/), doctoral student
- Xiangyu Wang, postdoc
- [Zhixing Li](https://www.chalmers.se/en/persons/zhixingl/), doctoral student
...
- Verify the staff list and employment categories against the department directory. The source group page marks its member list as a work in progress, and some people may belong primarily to another unit.
...
- Consider using the FP winter meeting group photograph from the Chalmers FP website as the lead image, subject to permission and availability of an accessible high-resolution original. Suggested alt text: "Members of the Functional Programming unit at the 2025 winter meeting."
...
<!-- This section documents the source material and may be removed before publication. -->

- [Computing Science division page](https://www.chalmers.se/en/departments/cse/our-research/computing-science/#functional-programming)
- [Logic and Types unit page](https://www.chalmers.se/en/departments/cse/our-research/computing-science/logic-and-types/)
- [Chalmers Functional Programming Group](https://chalmersfp.github.io/)
- [Functional Programming Research Group wiki](https://wiki.portal.chalmers.se/cse/pmwiki.php/FP/FP)
- [Chalmers Online Functional Programming Seminar Series](https://chalmersfp.github.io/series.html)
- [Yinan Yu, AIXLab@Chalmers](https://usableai.se/members/yinan)
